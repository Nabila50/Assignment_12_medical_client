...
const CampDetails = () => {
  ...
  if (isError) return <p className="text-center mt-10 text-red-500">Failed to load camp.</p>;
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-sky-50 rounded-lg mt-10">
      ...
      <h2 className="text-4xl font-bold text-[#00bcd5] mb-4">{camp.campName}</h2>
      ...
      >
        ...
        <h3 className="text-2xl font-bold mb-4 base-color">Registration for Participation</h3>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col">
            ...
            <input type="text" value={camp.campFees} readOnly className="input input-bordered w-full" />
          </div>
          ...
          <div className="flex flex-col">
            <label className="font-semibold mb-1">Healthcare Professional</label>
          ...
          <div className="flex flex-col">
            ...
            <input type="text" placeholder="Phone Number" {...register("phoneNumber", { required: true })} className="input input-bordered w-full" />
          </div>
          ...
          <div className="md:col-span-2 mt-4">
            <button type="submit" className="btn bg-[#00bcd5] text-white w-full">
              Submit Registration
            </button>
          </div>
        </form>
